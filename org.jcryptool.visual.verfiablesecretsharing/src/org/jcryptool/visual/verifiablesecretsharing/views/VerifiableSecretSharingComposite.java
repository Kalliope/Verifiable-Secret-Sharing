...
public class VerifiableSecretSharingComposite extends Composite {
	...
	private void createCoefficientsGroup(Composite parent, int coefficients) {
		...
		ScrolledComposite scrolledCoefficientsGroup = new ScrolledComposite(coefficientsGroup, SWT.V_SCROLL | SWT.FILL);
		scrolledCoefficientsGroup.setExpandHorizontal(true);
		scrolledCoefficientsGroup.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true));
